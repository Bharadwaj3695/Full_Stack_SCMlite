...
SOCKET_SERVER = os.getvenv("SOCKET_SERVER")
SOCKET_PORT = int(os.getvenv("SOCKET_PORT"))
BUFFER_SIZE = int(os.getvenv("BUFFER_SIZE"))
KAFKA_BOOTSTRAP_SERVERS = os.getvenv("KAFKA_BOOTSTRAP_SERVERS").split(",")
KAFKA_TOPIC = os.getvenv("KAFKA_TOPIC")
